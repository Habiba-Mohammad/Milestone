...
{props.language.map(language=>{
    ...
    <div className="degree">   يتناسب عمر طفلك مع أقرانه في التواصل واللغة بنسبة {(languageScore/props.language.length*100).toFixed(2)} %</div>
...
{props.cognition.map(cognition=>{
 ...
 <div className="degree">   يتناسب عمر طفلك مع أقرانه في الإدراك بنسبة {(cognitiveScore/props.cognition.length * 100).toFixed(2)} %</div>
            </div>
